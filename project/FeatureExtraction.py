...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("TrainEnglish/J/j_19.jpg")            # read in training numbers image
    ...
    np.savetxt("TrainLabls.txt", npaClassifications)           # write flattened images to file
    np.savetxt("TrainFeatures.txt", npaFlattenedImages)          #
